// Copyright (c) 2026 Adrian Student All rights reserved.
// .
// Created by: Adrian student
// Date: sep 21th, 2026
// This program asks the user for the length and the width of
// a rectangle, calculate and display the area and perimeter
